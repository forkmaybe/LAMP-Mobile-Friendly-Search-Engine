...
$template->set_filenames(array('job_search' => 'job_search.htm','job_search_result'=>'job_search_result1.htm','side_search_result'=>'side_search_result.html'));
...
// search
    ...
    //$keyword = preg_replace("c++", "cplusplus", $keyword);
    //$keyword=urldecode($keyword);
//$keyword = preg_replace("cplusplus", "c++", $keyword);
...
//echo $query;
      ...
      //LIST OF COMPANIES HERE NOW IS:
              if($row['recruiter_iframe']=="No"){                  //new tab
           ...
           /////////////////////////////////////////////////////////end of while loop
             ...
             //$totalNumberOfJobs=$i_page;//if no indeed comes back
             /////
